...
- [Vocabulary](#vocabulary)
  * [What are harvesters, farmers, full nodes, and timelords?](#what-are-harvesters--farmers--full-nodes--and-timelords-)
  * [What is a proof of space?](#what-is-a-proof-of-space-)
  * [What is a VDF/proof of time?](#what-is-a-vdf-proof-of-time-)
  * [What is XCH, TXCH, and mojos?](#what-is-xch--txch--and-mojos-)
- [Plotting](#plotting)
  * [What is k?](#what-is-k-)
  * [How big are plot sizes (k)?](#how-big-are-plot-sizes--k--)
  * [What k-size should you plot?](#what-k-size-should-you-plot-)
  * [What is recommended for plotting?](#what-is-recommended-for-plotting-)
  * [Can I plot more than one plot at a time?](#can-i-plot-more-than-one-plot-at-a-time-)
  * [Can I make plots on one machine and move it to another machine?](#can-i-make-plots-on-one-machine-and-move-it-to-another-machine-)
  * [What is the secondary temp directory `-2`, and how should I set it?](#what-is-the-secondary-temp-directory---2---and-how-should-i-set-it-)
  * [My plotting attempt got "Caught plotting error: Not enough memory..."?](#my-plotting-attempt-got--caught-plotting-error--not-enough-memory--)
  * [My plotting attempt ended with "RuntimeError: bad allocation"?](#my-plotting-attempt-ended-with--runtimeerror--bad-allocation--)
  * [My computer/drive went into power save or rebooted while plotting?](#my-computer-drive-went-into-power-save-or-rebooted-while-plotting-)
  * [Do I have to be connected to the internet or synced to plot?](#do-i-have-to-be-connected-to-the-internet-or-synced-to-plot-)
  * [Is there any advantage in plotting larger k sizes?](#is-there-any-advantage-in-plotting-larger-k-sizes-)
  * [Is the final size of the plotted space the only variable in how often I can win block rewards?](#is-the-final-size-of-the-plotted-space-the-only-variable-in-how-often-i-can-win-block-rewards-)
  * [How do I know if my plots are OK?](#how-do-i-know-if-my-plots-are-ok-)
- [Full Node](#full-node)
  * [What is this UPnP Error?](#what-is-this-upnp-error-)
  * [Why should I not run more than one node on a home network and what's this about UPnP?](#why-should-i-not-run-more-than-one-node-on-a-home-network-and-what-s-this-about-upnp-)
  * [Why does my node have no connections? How can I get more connections?](#why-does-my-node-have-no-connections--how-can-i-get-more-connections-)
  * [I am seeing blocks and connections but my node says "Not Synced"](#i-am-seeing-blocks-and-connections-but-my-node-says--not-synced-)
- [Farming](#farming)
  * [How do I tell if I'm farming correctly?](#how-do-i-tell-if-i-m-farming-correctly-)
  * [Does it matter how fast my internet connection is?](#does-it-matter-how-fast-my-internet-connection-is-)
  * [I have only 10 TB, will I ever win XCH on mainnet?](#i-have-only-10-tb--will-i-ever-win-xch-on-mainnet-)
  * [What is the plot filter and why didn't my plot pass it?](#what-is-the-plot-filter-and-why-didn-t-my-plot-pass-it-)
  * [Can I join a farming pool?](#can-i-join-a-farming-pool-)
  * [I have heard that it's recommended that a winning plot be deleted on mainnet?](#i-have-heard-that-it-s-recommended-that-a-winning-plot-be-deleted-on-mainnet-)
  * [Do my plots "wear out" or "go bad"/"go stale" over time? Will I have to regularly re-plot?](#do-my-plots--wear-out--or--go-bad---go-stale--over-time--will-i-have-to-regularly-re-plot-)
  * [Is it possible to have a proof but not get a reward?](#is-it-possible-to-have-a-proof-but-not-get-a-reward-)
- [Wallet](#wallet)
  * [How do I send or receive a transaction?](#how-do-i-send-or-receive-a-transaction-)
  * [What is the Coin model?](#what-is-the-coin-model-)
  * [What are HD Keys?](#what-are-hd-keys-)
  * [How many confirmations do I need to trust a chia transaction is final?](#how-many-confirmations-do-i-need-to-trust-a-chia-transaction-is-final-)
  * [Why is my wallet not synced? Why can I not connect to wallet from the GUI?](#why-is-my-wallet-not-synced--why-can-i-not-connect-to-wallet-from-the-gui-)
- [Support/Miscellaneous](#support-miscellaneous)
  * [What are the minimum officially supported OS versions?](#what-are-the-minimum-officially-supported-os-versions-)
  * [Can I run this on a Raspberry Pi 3 or 4?](#can-i-run-this-on-a-raspberry-pi-3-or-4-)
  * [How do I upgrade and keep my keys and plots?](#how-do-i-upgrade-and-keep-my-keys-and-plots-)
  * [What are the plans for the project and what are its tokenomics?](#what-are-the-plans-for-the-project-and-what-are-its-tokenomics-)
