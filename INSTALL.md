...
Install the Windows installer - [Chia Blockchain Windows](https://download.chia.net/beta-1.23-win64/ChiaSetup-0.1.23.exe)
...
Install the MacOS dmg installer - [Chia Blockchain MacOS](https://download.chia.net/beta-1.23-macos/Chia-0.1.23.dmg)
...
pip install chia-blockchain==1.0b23
```
