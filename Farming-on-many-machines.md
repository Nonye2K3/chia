...
4. Run `chia init -c [directory]` on your remote harvester, where `[directory]` is the the copy of your **main** machine CA directory. This command creates a new certificate based signed by your **main** machine's CA.
