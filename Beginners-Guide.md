...
#(FYI) The information above is an example- the table shows % of computer usage of processor/ ram  used (estimated) at each stage.  If a user has a fast pc and large amount of ram --compared to older pc and low ram- both  still plot just different amount of total time to create the plot.
#### Notes
