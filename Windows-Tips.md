1. To plot parallel in Windows you will need to use powershell. A generic example for Beta 17:
> ```
> cd C:\Users\yourUserName\AppData\Local\Chia-Blockchain\app-0.1.20\resources\app.asar.unpacked\daemon\
> start-process ./chia.exe -argumentlist "plots create yourParametersGoHere"
> start-process ....
> ....
> ```
>
> A specific example, again using Beta 20:
> ```
> cd C:\Users\yourUserName\AppData\Local\Chia-Blockchain\app-0.1.20\resources\app.asar.unpacked\daemon\
> start-process ./chia.exe -argumentlist "plots create -k 32 -b 4508 -u 128 -r 4 -t d:\tempdrive1 -2 e:\tempdrive2 -d F:\plots -n 1"
> ```
> If you are using Beta 16 you would change the `Chia-Blockchain\app-0.1.20\resources\` section to `Chia-Blockchain\app-0.1.16\resources\` in the command above.
