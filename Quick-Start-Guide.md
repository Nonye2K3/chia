...
There are commands available on `~\AppData\Local\Chia-Blockchain\app-1.0.0\resources\app.asar.unpacked\daemon\`. Try `.\chia -h` or `.\chia plots -h` for example:
...
You can check these [Windows Tips](https://github.com/Chia-Network/chia-blockchain/wiki/Windows-Tips). And read more about commands in general at [CLI Commands Reference](https://github.com/Chia-Network/chia-blockchain/wiki/CLI-Commands-Reference).
